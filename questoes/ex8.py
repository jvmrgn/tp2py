...
def adicionar_coluna_ano_nascimento(dataframe):
    """
    Adiciona uma coluna 'ano_nascimento' ao dataframe com base na idade e ano atual.
    """
    ano_atual = datetime.now().year
    dataframe['ano_nascimento'] = ano_atual - dataframe['idade']
    return dataframe
...
def main():
    ...
    try:
        ...
        dados = adicionar_coluna_ano_nascimento(dados)
        print(dados)
